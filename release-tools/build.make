...
build: install-deps
	# generate libs
	cd .. && ./bin/protoc --proto_path=proto --proto_path=. --go_out=lib/go --go_opt=paths=source_relative --plugin=./bin/protoc-gen-go $(OPERATION)/$(OPERATION).proto
	cd .. && ./bin/protoc --proto_path=proto --proto_path=. --go-grpc_out=lib/go --go-grpc_opt=paths=source_relative --plugin=./bin/protoc-gen-go-grpc $(OPERATION)/$(OPERATION).proto
